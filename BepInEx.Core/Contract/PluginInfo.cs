...
public class PluginInfo : ICacheable
{
    ...
    /// <summary>
    /// Collection of <see cref="BepInIncompatibility" /> attributes that describe what plugins this plugin is incompatible with.
    /// </summary>
    ...
    /// <summary>Full name of the plugin type.</summary>
