...
public static class Paths
{
    ...
    /// <summary>Derives all well-known paths from the game executable location.</summary>
    /// <param name="executablePath">Full path to the game executable.</param>
    /// <param name="bepinRootPath">Root path of the BepInEx installation. Derived from the executable path if null.</param>
    /// <param name="managedPath">Path to the managed game assemblies. Derived from the executable path if null.</param>
    /// <param name="gameDataRelativeToManaged">Whether the game data folder sits next to the managed folder.</param>
    /// <param name="dllSearchPath">Additional directories Mono searches for assemblies.</param>
